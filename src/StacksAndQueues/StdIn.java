 ...
 *  Compilation:  javac StacksAndQueues.StdIn.java
 *  Execution:    java StacksAndQueues.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code StacksAndQueues.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code StacksAndQueues.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">StacksAndQueues.StdIn.java</a>
 ...
 *  <pre>
 *  while (!StacksAndQueues.StdIn.isEmpty()) {
 *      double value = StacksAndQueues.StdIn.readDouble();
 *      StacksAndQueues.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (StacksAndQueues.StdIn.hasNextChar()) {
 *      char c = StacksAndQueues.StdIn.readChar();
 *      StacksAndQueues.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (StacksAndQueues.StdIn.hasNextLine()) {
 *      String line = StacksAndQueues.StdIn.readLine();
 *      StacksAndQueues.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = StacksAndQueues.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code StacksAndQueues.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code StacksAndQueues.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code StacksAndQueues.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code StacksAndQueues.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code StacksAndQueues.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code StacksAndQueues.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code StacksAndQueues.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code StacksAndQueues.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code StacksAndQueues.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to StacksAndQueues.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to StacksAndQueues.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to StacksAndQueues.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to StacksAndQueues.StdIn

    // do this once when StacksAndQueues.StdIn is initialized
    static {
        resync();
    }

    /**
     * If StacksAndQueues.StdIn changes, use this to reinitialize the scanner.
     */
